...
parser = argparse.ArgumentParser(description="基线问题导出工具")
...
for project in projects:
  ...
  subprocess.call("java -jar ./razor.jar -Dproject=%s -Dprovider=CLE -Duser=%s -Dpassword=%s "
                    "-Dexcelpath=./output/基线问题汇总.xlsx -Dsheetname=test1 -Duri=http://192.168.8.250:8081 "
                    "-Dissuestatus=TODO,DOING" % (project, results.user, results.password), shell=True);